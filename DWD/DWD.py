...
class DWDWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def initializeParameterNode(self):
        ...
        # etc. so that when the scene is saved and reloaded, these settings are restored.
    ...
    def updateParameterNodeFromGUI(self, caller=None, event=None):
        """This method is called when the user makes any change in the GUI. The
        changes are saved into the parameter node (so that they are restored when the
        scene is saved and loaded).
        """
